...
export const MissionIcon: IconComponent = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1v12z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 21v-6" /></svg>
);
export const StoreIcon: IconComponent = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>
);
export const InventoryIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" /></svg>
);
export const RankingIcon: IconComponent = (props) => (
...
export const TrophyIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 19V6.13a2 2 0 012-2h2a2 2 0 012 2V19M5 19h14M3 19h2m14 0h2M12 4V2" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 9H6a2 2 0 00-2 2v2m14-4h2a2 2 0 012 2v2" />
    </svg>
);
export const TicketIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
    </svg>
);
export const SubscriptionIcon: IconComponent = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
);
export const EventIcon: IconComponent = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 11h2m2 0h2" /></svg>
);
export const ProfileIcon: IconComponent = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 11c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" /></svg>
);
export const AdminIcon: IconComponent = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6v12m8-12v12m8-12v12M2 9h4m4 0h4m4 0h4" /></svg>
);
export const CoinIcon: IconComponent = (props) => {
    ...
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id={`goldGradient-${id}`} x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style={{stopColor: '#FBBF24'}} />
                <stop offset="100%" style={{stopColor: '#D97706'}} />
            </linearGradient>
        </defs>
        <circle cx="12" cy="12" r="11" fill={`url(#goldGradient-${id})`} />
        <circle cx="12" cy="12" r="11" fill="none" stroke="#B45309" strokeWidth="1.5" />
        <circle cx="12" cy="12" r="9.5" fill="none" stroke="#FDE68A" strokeWidth="1" opacity="0.9" />
...
export const XPIcon: IconComponent = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 11l7-7 7 7M5 19l7-7 7 7" /></svg>
);
...
export const CrownIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 16L3 5l5.5 5L12 4l3.5 6L21 5l-2 11H5z" />
    </svg>
);
...
// New Icons
export const SpotifyIcon: IconComponent = (props) => (
...
export const TikTokIcon: IconComponent = (props) => (
...
export const VipIcon: IconComponent = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const SoundWaveIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const DiscountIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const DetailsIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const PromoteIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
    </svg>
);
...
export const RefundIcon: IconComponent = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor">
